          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex gap-3 items-center">
                ...
                <button onClick={() => handleAddToCart(product)} className="flex-1 bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-lg flex items-center justify-center gap-2 transition">
              ...
              <div className="flex gap-6 pt-4 border-t border-gray-200">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-700">Certified Producer</span>
                </div>
                <div className="flex items-center gap-2">
                  <Check size={20} className="text-green-600" />
                  <span className="text-sm text-gray-700">Non-GMO Project Verified</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-16 pt-8 border-t border-gray-200">
            ...
            <div className="prose prose-sm max-w-none">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                {product.description} - This is a premium agricultural product carefully selected for professional farmers and growers. Our commitment to quality ensures you receive only the finest seeds and materials.
              </p>
              <ul className="space-y-2 text-gray-700">
                <li>
                  <strong>High Yield Potential:</strong> Genetically optimized for maximum grain output per acre.
                </li>
                <li>
                  <strong>Drought Resistance:</strong> Maintains performance during periods of low rainfall.
                </li>
                <li>
                  <strong>Strong Stalks:</strong> Excellent standability and lodging resistance for an easier harvest.
                </li>
                <li>
                  <strong>Disease Tolerance:</strong> Built-in resistance to common crop diseases, reducing the need for fungicides.
                </li>
              </ul>
            </div>
          </div>
