      ...
      <div className="bg-white rounded-lg p-6 shadow-sm space-y-6">
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            <label className="flex items-center gap-2 cursor-pointer text-sm text-gray-700 hover:text-green-600">
        ...
        <div className="space-y-3 pt-4 border-t border-gray-200">
          ...
          <div className="space-y-2">
            <label className="flex items-center gap-2 cursor-pointer text-sm text-gray-700 hover:text-green-600">
              <input type="radio" name="price" defaultChecked className="accent-green-600" />
        ...
        {/* Clear Button */}
        <button className="w-full bg-gray-100 hover:bg-green-600 hover:text-white text-gray-800 font-semibold py-2 rounded-lg transition mt-4">
          Clear All Filters
        </button>
      </div>
    </aside>
